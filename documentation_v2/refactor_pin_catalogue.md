...
| `apps/fleet_host_agent/src/ledger_client/mod.rs:3` | `docs/verification/api_v2/fleet_command_ledger.md` | `documentation_v2/website/api_v2/verification/fleet_command_ledger.md` | P2-2 | comment | - |
...
| `apps/website/api_v2/src/missions/services/mission_artifacts/mod.rs:2` | `docs/verification/api_v2/mission_artifacts.md` | `documentation_v2/website/api_v2/verification/mission_artifacts.md` | P2-2 | comment | - |
| `apps/website/api_v2/src/server_infrastructure/services/fleet_commands/mod.rs:2` | `docs/verification/api_v2/fleet_command_ledger.md` | `documentation_v2/website/api_v2/verification/fleet_command_ledger.md` | P2-2 | comment | - |
...
| `tools_v2/xtask/src/core/repository_layout.rs:(new)` | `API_READINESS_EVIDENCE_PREFIX and API_READINESS_REGISTER values` | `documentation_v2/website/api_v2/verification/ and documentation_v2/website/api_v2/verification/requirements.json` | P2-2 | code | after P1-4 adds the constants; verify api-readiness must resolve the register |
...
| `apps/fleet_host_agent/README.md:9` | `docs/verification/api_v2/fleet_command_ledger.md` | `/documentation_v2/website/api_v2/verification/fleet_command_ledger.md` | P2-6 | prose | - |
...
| `apps/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/README.md:51` | `docs/verification/equipment-vehicle-export/` | `/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification/` | P2-6 | prose | - |
...
| `apps/website/api_v2/src/server_infrastructure/README.md:34` | `docs/verification/api_v2/fleet_command_ledger.md` | `/documentation_v2/website/api_v2/verification/fleet_command_ledger.md` | P2-6 | prose | - |
