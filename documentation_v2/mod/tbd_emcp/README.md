...
- `mcpd Daemon`: Local broker daemon (`tools/tbd-tools/src/bin/mcpd.rs`) interfacing AI agents with the Workbench NetAPI socket.
...
- Broker Daemon: `tools/tbd-tools/src/bin/mcpd.rs`
