...
The [mod](/documentation_v2/glossary/g_to_m.md#mod) builds no player options; the game's own settings apply. The [in-game menu specification](/documentation_v2/mod/tbd-framework/UI/in_game_menu/in_game_menu_specification.md) feature doc holds the full comparison.
