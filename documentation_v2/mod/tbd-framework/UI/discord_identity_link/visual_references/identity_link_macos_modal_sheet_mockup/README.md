...
([ORBAT](/documentation_v2/glossary/n_to_z.md#orbat) [slot](/documentation_v2/glossary/n_to_z.md#slot) reservation, combat telemetry, Discord rank sync), a one-time passcode card (`TBD-8X2K`,
