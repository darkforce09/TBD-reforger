...
The deeper documents of the Arma Reforger [mod](/documentation_v2/glossary.md#mod), one folder per
[Enfusion](/documentation_v2/glossary.md#enfusion) addon under `apps/mod/`: the game framework's
...
| `TBD_EMCP` | the nineteen Net API handlers the Enfusion MCP tools call in [Workbench](/documentation_v2/glossary.md#workbench) | [Enfusion MCP bridge](/documentation_v2/mod/tbd-emcp/workbench_mcp_bridge.md) |
...
| `cargo xtask mod world-boot` | the development [mission header](/documentation_v2/glossary.md#mission-header) boots headless |
...
- [Glossary](/documentation_v2/glossary.md) — mod, Enfusion, Workbench, EnfScript and mission
  header.
