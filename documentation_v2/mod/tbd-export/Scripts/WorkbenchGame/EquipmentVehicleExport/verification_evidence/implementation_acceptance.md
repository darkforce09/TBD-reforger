...
- [Old-to-new field inventory](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/field-mapping/inventory.json): all 706 observed field paths have a disposition; grouped files contain each decision and its audit finding numbers.
- [Workbench cases](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/workbench-native-acceptance.json): 32 installed resources checked against native primitive getters and ordered object relationships.
- [Compile evidence](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/workbench-compilation.json): successful WorkbenchGame module load after the required initial cold restart and subsequent script reloads.
- [Code hashes](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/source-code-manifest.json): source reader, validator/publisher, tests and contract used for acceptance.
- [Original file hashes](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/legacy-input-manifest.json): all 160 old files match the original audit.
- [Original prefab references](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/legacy-resource-inventory.json): 1,336 exact resource names, including catalog resources and referenced dependencies.

[Publication and archive proof](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/publication.json) records the current pointer, sealed manifest, and verified original files.
...
[Validation summary](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/validation-summary.json), [coverage](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/coverage-summary.json), [repeatability](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/repeatability.json), and [reader fixtures](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/source-reader-verification.json) record the acceptance checks. All 21 Rust regression tests pass. The [32 native Workbench cases](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/workbench-native-acceptance.json) pass against the final scripts.
...
- [IIFS backpack](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/iifs_inventory_storage.json): remove the invented 4 × 75 grid. Keep native volume, dimensions, size enum and storage restrictions separately.
- [M997](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/m997_mass_cargo_fuel.json): keep the child cargo weight limit of 870 and volume limit of 100000, alongside native fuel, engine and buoyancy fields. [Catalog mass](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/m997_catalog_mass.json) points to `RigidBody.Mass = 2791`, replacing the inherited generic value of 1.
- [M16 fire modes](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/m16_fire_modes.json): preserve Safe, Single and Burst configurations instead of labeling every mode Safety.
- [Terminal tracer magazine](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/terminal_magazine.json): retain the ordered mapping and ammunition configuration; remove calculated ratios and loaded weights.
- [AN/PRC-68](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/radio_transceivers.json): retain each transceiver's range and frequency; 1300 is a native range value, not a wattage specification.
- [Saline](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/saline_effect.json) and [morphine](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/morphine_effect.json): retain concrete effect classes and separate amounts, speeds and durations, including legitimate zero values.
- [M252 mortar](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/before-after/mortar_default_projectile.json): keep the default projectile relationship and source mass fields without substituting a family or destroyed-debris mass.
...
- There are 17 unresolved nonempty localization entries; [their exact source locations and keys](/documentation_v2/mod/tbd-export/Scripts/WorkbenchGame/EquipmentVehicleExport/verification_evidence/unresolved-localization.json) are recorded. Another 9,856 unavailable English entries have empty source names, mainly technical/action UI containers. These are name-entry counts, not missing inventory resources. Original text/keys remain intact.
