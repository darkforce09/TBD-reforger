...
| P1-5b | 1 | Documentation gates, part 2: link check core — Markdown link scan, heading anchors, target resolution (repo-root/relative, folders, line anchors, own-repo permalinks), `link-check [--report]` verb | pending | — | — |
