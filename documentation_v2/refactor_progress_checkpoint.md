...
| P1-5af | 1 | Fix run: exempt folders' READMEs skip the Contents check; spacer lines allowed; `verifications/README.md` lists `documentation/` | pending | — | — |
| P1-5b | 1 | Documentation gates, part 2: link check (anchors, targets, permalinks, backticked paths, xtask command citations), `link-check [--report]` verb | pending | — | — |
