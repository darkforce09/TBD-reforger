...
| P1-5bf | 1 | Fix run: link-check excludes `.ai/artifacts/`; accepts the repository's non-code pages and `tree/<sha>` folder permalinks; `verifications/README.md` names link-check | pending | — | — |
