...
**Program complete (2026-07-03)** — T-126 ✓ → T-127 ✓ → T-128 ✓ → **T-130 ✓** @ `90c9f261` (tag **T-130**). **Main queue:** **T-090.1.2.5** / [`docs/TICKET_LEAD.md`](https://github.com/darkforce09/TBD-reforger/blob/2574b0ed2f76edb131447eb10e3d55446404d785/docs/TICKET_LEAD.md).
...
| Everything else | See [`docs/TICKET_LEAD.md`](https://github.com/darkforce09/TBD-reforger/blob/2574b0ed2f76edb131447eb10e3d55446404d785/docs/TICKET_LEAD.md) |
...
**North Star gaps (unplanned backlog):** [`tbd_north_star_backlog.md`](/documentation_v2/tickets/specs/t131_north_star_backlog.md) · registry **T-131…T-142** (`idea`).
...
|----|--------|------|----------|
| **T-126** | shipped @ `4a47688e` | [`t126_audit_security_followup.md`](/documentation_v2/tickets/specs/t126_audit_security_followup.md) | claude-code |
| **T-127** | shipped @ `0515aabb` | [`t127_mc_ux_audit_fixes.md`](/documentation_v2/tickets/specs/t127_mc_ux_audit_fixes.md) | claude-code |
| **T-128** | shipped (tag `T-128`) | [`t128_doc_link_repair.md`](/documentation_v2/tickets/specs/t128_doc_link_repair.md) | cursor-docs |
| **T-130** | shipped @ `90c9f261` (tag `T-130`) | [`t130_fable_audit_remainder.md`](/documentation_v2/tickets/specs/t130_fable_audit_remainder.md) | claude-code + cursor-docs |
