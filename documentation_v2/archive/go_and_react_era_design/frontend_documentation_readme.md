...
| Resource | Purpose |
|----------|---------|
| [`INDEX.md`](/documentation_v2/website/frontend/README.md) | Master table of 28 route/shell/auth surface specs |
| [`THEME.md`](/documentation_v2/design_system/design_tokens.md) | Aegis design tokens in use |
