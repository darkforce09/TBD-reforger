...
```text
documentation_v2/archive/product_plans/
├── discord_milestone_1_post.md          community announcement of the first milestone, ready to paste
├── mod_milestones.md                    the milestones, each ending in an event on real infrastructure
└── tbd_reforger_platform_build_plan.md  master build plan: design pillars, architecture, phases
```

## Code

None: the plans describe the product, not a code folder.
...
- [Product roadmap](/documentation_v2/product_roadmap.md) — the live plan, with the build plan's
  items still to do.
- [Mod documentation](/documentation_v2/mod/README.md) — the mod as it is.
