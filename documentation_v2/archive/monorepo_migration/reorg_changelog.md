...
Authority: [`docs/TAGS.md`](/documentation_v2/standards/ticket_identifiers.md) · [`tickets/AI_PLAYBOOK.md`](/.ai/tickets/agent_playbook.md)

## 2026-06-30 — Frontend surface specs consolidated

| Old | New |
|-----|-----|
| `apps/website/frontend/docs/**` | `docs/website/frontend/**` (INDEX, pages/, shell/, auth/, THEME, TRACKING, _template) |

The T-043 alias `docs/frontend/` never existed on disk; canonical path is **`docs/website/frontend/`**.
Retired shorthand: `frontend/docs/`. See [`DOCUMENTATION_STANDARDS.md`](/documentation_v2/standards/documentation_standards.md) §8.2.
