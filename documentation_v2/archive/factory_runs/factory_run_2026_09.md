...
[`EYE_PASS_2026-09.md`](/documentation_v2/archive/factory_runs/eye_pass_2026_09.md). Operator decisions: Reforger only · mod scripts
...
- 2026-09-05 First slice gate of the run (T-311) exposed three trunk defects on `main`, none in
  any slice's owns: (1) `apps/website/api_v2/.gitignore` `missions/` also ignored
