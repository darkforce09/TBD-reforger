...
|---|---|---|---|
| `enf` | indexes [Enfusion](/documentation_v2/glossary.md#enfusion) scripts, extracts vanilla scripts from the paks, checks citations and capability verdicts | [Enfusion script oracle](/documentation_v2/tools_v2/developer-tools/enfusion_script_oracle.md) | [`src/enfusion_tooling/`](/tools_v2/developer-tools/src/enfusion_tooling/README.md) |
| `mcpd` | the Unix-socket broker over one enfusion-mcp server for the [Workbench](/documentation_v2/glossary.md#workbench) NetAPI | [Enfusion MCP tooling runbook](/documentation_v2/runbooks/enfusion_mcp_tooling.md) | [`src/enfusion_tooling/`](/tools_v2/developer-tools/src/enfusion_tooling/README.md) |
...
| `capture` | screenshots, zoom sweeps and crops of a running [Mission Creator](/documentation_v2/glossary.md#mission-creator) | [Editor capture runbook](/documentation_v2/runbooks/editor_capture.md) | [`src/browser_testing/screen_capture/`](/tools_v2/developer-tools/src/browser_testing/screen_capture/README.md) |
