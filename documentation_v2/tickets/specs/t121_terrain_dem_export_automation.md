...
3. ~~**MCP helper hardening**~~ — **shipped** @ `e7e7232`: warm daemon + hardened one-shot, pinned `enfusion-mcp@0.6.1`, offline self-test + live smoke. See [`docs/mod/MCP_TOOLING.md`](/documentation_v2/runbooks/enfusion_mcp_tooling.md).
