...
The documentation of the [Mission Creator](/documentation_v2/glossary/g_to_m.md#mission-creator)'s
[arsenal](/documentation_v2/glossary/a_to_f.md#arsenal): the Attributes dialog's Arsenal tab, where a
mission maker edits one [slot](/documentation_v2/glossary/n_to_z.md#slot)'s loadout, and the design
...
[mission](/documentation_v2/glossary/g_to_m.md#mission) document, what the rules refuse, and how the built
...
- Depends on: the [feature doc template](/documentation_v2/standards/templates/feature_doc.md), the
  ...
  and the [glossary](/documentation_v2/glossary/README.md); the arsenal code, the registry handlers in
