...
to the Discord sign-in the [API](/documentation_v2/glossary/a_to_f.md#api) runs, the API redirects to
...
- [Session and access](/apps/website/frontend/src/v2/core/auth/) — the session store, its
  persistence and the [role](/documentation_v2/glossary/n_to_z.md#role) ladder the pages read and write.
- [Identity and access domain](/apps/website/api_v2/src/identity_and_access/) — the Discord
  sign-in, the [dev login](/documentation_v2/glossary/a_to_f.md#dev-login), the profile and the Arma
  link routes.
...
- Depends on: the [feature doc template](/documentation_v2/standards/templates/feature_doc.md) and
  ...
  the [glossary](/documentation_v2/glossary/README.md); the page code, the identity and access handlers
