...
The documentation of the three [mission](/documentation_v2/glossary/g_to_m.md#mission) hub pages, one
...
[API](/documentation_v2/glossary/a_to_f.md#api)), Data (what each call means server-side), Design, Open
...
the [approvals](/documentation_v2/glossary/a_to_f.md#approvals) page render and whose in-code README
describes it.
