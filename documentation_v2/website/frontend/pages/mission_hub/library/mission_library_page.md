...
### States
- **Unavailable artwork:** failed stored or fallback imagery uses a local decorative gradient in the hero, cards and dossier. Valid artwork, URL safety, dimensions and mission controls remain intact.
