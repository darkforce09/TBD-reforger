...
[operations](/documentation_v2/glossary/n_to_z.md#operations) section, where a member browses the
upcoming [events](/documentation_v2/glossary/a_to_f.md#event) beside the selected event's hub, with the
...
[API](/documentation_v2/glossary/a_to_f.md#api), and compares the built page with the blueprint in
...
- Used by: the page's in-code README, the operations pages README and the operations domain
  README, which link the feature doc; the [event](/documentation_v2/glossary/a_to_f.md#event) glossary
