...
# Leaderboards design references

The design references of the `/leaderboards` page: one design-phase blueprint set, kept for colour
and layout context rather than as an implementation source.

## Contents

```text
documentation_v2/website/frontend/pages/operations/leaderboards/visual_references/
└── leaderboards_blueprint/  category tabs and search over a three-place podium and a ranked roster
```
...
- [Leaderboards page](/apps/website/frontend/src/v2/pages/operations/leaderboards/) — the built page
