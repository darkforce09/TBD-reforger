...
# Deployments design references

The design references of the `/deployments` page: one design-phase blueprint set, kept for colour
and layout context rather than as an implementation source.

## Contents

```text
documentation_v2/website/frontend/pages/operations/deployments/visual_references/
└── service_record_blueprint/  a member's career figures beside active orders and a combat history
```
...
- [Deployments page](/apps/website/frontend/src/v2/pages/operations/deployments/) — the built page
