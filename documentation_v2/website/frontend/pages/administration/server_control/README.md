...
issue [fleet commands](/documentation_v2/glossary/a_to_f.md#fleet-command), deploy approved
[missions](/documentation_v2/glossary/g_to_m.md#mission), keep the
[registry](/documentation_v2/glossary/n_to_z.md#registry) of
[fleet scenarios](/documentation_v2/glossary/a_to_f.md#fleet-scenario) and manage
[machine credentials](/documentation_v2/glossary/g_to_m.md#machine-credential). The page has no design set:
...
- [Missions domain](/apps/website/api_v2/src/missions/) — the
  [mission deployment](/documentation_v2/glossary/g_to_m.md#mission-deployment) routes.
...
- Used by: the [server control](/documentation_v2/glossary/n_to_z.md#server-control) glossary entry, the
