...
administrators schedule and edit [events](/documentation_v2/glossary/a_to_f.md#event), attach
[missions](/documentation_v2/glossary/g_to_m.md#mission) and set who may join them, with the page's
...
then lists where the page's wording and the [API](/documentation_v2/glossary/a_to_f.md#api) disagree; its
...
- Depends on: the feature doc template; the page code and the operations handlers the feature doc
  is written from.
- Used by: the [event manager](/documentation_v2/glossary/a_to_f.md#event-manager) glossary entry and the
