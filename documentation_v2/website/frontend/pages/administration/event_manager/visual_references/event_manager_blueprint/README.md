...
Design-phase reference for the [event manager](/documentation_v2/glossary/a_to_f.md#event-manager) page at
...
[missions](/documentation_v2/glossary/g_to_m.md#mission), a lifecycle state, a briefing, a banner and a
[slot](/documentation_v2/glossary/n_to_z.md#slot) ceiling; and an access sheet, which the blueprint does
