...
[artifacts](/documentation_v2/glossary/a_to_f.md#artifact) that submitted
[missions](/documentation_v2/glossary/g_to_m.md#mission) compiled into and decide them, with the page's
...
- Used by: the [approvals](/documentation_v2/glossary/a_to_f.md#approvals) glossary entry and the page's
