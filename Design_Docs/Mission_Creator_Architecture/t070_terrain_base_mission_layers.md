...
- **T-062:** Interactive incremental `bindings.ts` — patch Zustand O(k) on classified everyday edits @ 360k (**shipped**). IDB streaming / batch save → **T-062.1+**.
...
- Implementing before **T-063..T-067** scale milestones + Eden **T-068+**
