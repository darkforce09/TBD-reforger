...
const RECIPE_CONST: &str = "tools_v2/xtask/src/mk_db.rs SEEDS";
...
/// T-902 deleted `scripts/platform/wave.sh`; both paths now live in `tools_v2/xtask/src/wave/gate.rs`
/// as `VERIFY_STEPS` iterated by `gate_slice` and `cmd_gate`.
const WAVE_REL: &str = "tools_v2/xtask/src/wave/gate.rs";
