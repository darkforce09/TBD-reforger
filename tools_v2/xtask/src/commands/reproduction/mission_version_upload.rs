...
pub fn run() -> Result<u8> {
    ...
    let mid = crate::commands::reproduction::fixtures::mission_id_from_json(&create_json)?;
    println!("    mission={mid}");
    ...
    for mb_str in sizes_mb.split_whitespace() {
        ...
        crate::commands::reproduction::fixtures::cmd_mission_version_body(&f, mb, &semver)?;
