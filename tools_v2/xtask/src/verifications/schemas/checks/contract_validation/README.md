...
[mission](/documentation_v2/glossary/g_to_m.md#mission) file. The parent file
...
then validates the faction library, the loadout exports, the [Mission Creator](/documentation_v2/glossary/g_to_m.md#mission-creator) payload, the bridge
message samples, the Everon terrain manifest, locations, height labels and anchors example, the
[Enfusion](/documentation_v2/glossary/a_to_f.md#enfusion) DTO fixtures (each against the mission schema's `#/$defs/<name>`), the map-object
...
or, for schemaVersion `1.1`, has a [slot](/documentation_v2/glossary/n_to_z.md#slot) count that differs from the [ORBAT](/documentation_v2/glossary/n_to_z.md#orbat)'s role counts or a
...
- Used by: `tools_v2/xtask/src/commands/schema/dispatch.rs` (`schema validate`,
  ...
  `tools_v2/xtask/src/commands/ci/task_definitions.rs`; the platform [wave](/documentation_v2/glossary/n_to_z.md#wave) gate's schema step
