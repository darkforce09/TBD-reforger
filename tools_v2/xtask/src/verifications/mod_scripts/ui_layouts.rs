...
//! awk half is [`crate::verifications::mod_scripts::ui_layout_parser`] — a pure `text -> Vec<String>` function with no
...
//! [`crate::verifications::mod_scripts::ui_layout_parser`]'s "MEASURED DEVIATION" section, because that is where the code
...
use crate::verifications::mod_scripts::ui_layout_parser::Analyzer;
...
#[cfg(test)]
#[path = "tests/ui_layouts/tests.rs"]
mod tests;
