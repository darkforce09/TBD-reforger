...
The line-level helpers of the [Enfusion](/documentation_v2/glossary.md#enfusion) `.layout` parser in
...
- Rules: records split on `\n` alone, so a trailing `\r` stays part of the line
  (`records_keep_a_trailing_carriage_return`); quoted strings, [Workbench](/documentation_v2/glossary.md#workbench) GUIDs among them, are
