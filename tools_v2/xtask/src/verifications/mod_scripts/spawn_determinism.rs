...
fn probe_status_num(err: &verification_core::NotRun) -> i32 {
    match err {
        verification_core::NotRun::ToolAbsent(_) => 127,
        _ => 2,
    }
}
...
#[cfg(test)]
#[path = "tests/spawn_determinism/tests.rs"]
mod tests;
