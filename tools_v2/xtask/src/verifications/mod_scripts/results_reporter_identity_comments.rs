...
//! [`crate::verifications::mod_scripts::player_identity_comments`] (the T-452 port) — same shape, different file and different lies.
//!
...
//!
//! * **The matcher is compiled in.** [`verification_core::Pattern`] is the `regex` crate. There is no
