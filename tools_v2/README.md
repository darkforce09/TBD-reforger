...
- `ticket-engine`: typed storage and operations, validation, sync outputs (queue JSON, roadmap markers, gap-analysis ticket columns), registry compatibility, ticket maintenance, wave scheduling/history, receipts, and estimates; no workspace dependencies.
