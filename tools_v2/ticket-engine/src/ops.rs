...
//! are replicated from `tools_v2/xtask/src/cmds.rs` (`cmd_set_status`, `cmd_ship`,
...
/// `tools_v2/xtask/src/cmds.rs` (itself a mirror of `.ai/tickets/schema.json` `$defs.status`).
