...
Source modules: `arsenal.rs`, `cur.rs`, `editor_boot_scenarios.rs`, `fullmap.rs`, `marquee_drag.rs`, `mutations.rs`, `outliner_drag.rs`, `outliner_palette.rs`, `pan.rs`, `run_smoke.rs`, `save_dialog_rect.rs`, `virtual_outliner.rs`.
