...
pub fn validate_export_artifacts() -> Result<u8> {
...

    {
        ...
        let sources = [
            "tools_v2/developer-tools/src/world/build.rs",
            "tools_v2/developer-tools/src/world/gates.rs",
            "tools_v2/developer-tools/src/world/aux.rs",
            "tools_v2/xtask/src/gate_export_terrain.rs",
            "tools_v2/developer-tools/src/geometry.rs",
            "tools_v2/developer-tools/src/density.rs",
            "tools_v2/developer-tools/src/forest.rs",
        ];
