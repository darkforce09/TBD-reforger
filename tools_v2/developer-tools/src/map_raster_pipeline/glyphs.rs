    ...
    for (i, key) in keys.iter().enumerate() {
        ...
        icons.insert(
            ...
            json!({
                ...
                "anchorX": crate::world_export_pipeline::json_number_formatting::js_math_round(ax * f64::from(CELL_PX)) as i64,
                "anchorY": crate::world_export_pipeline::json_number_formatting::js_math_round(ay * f64::from(CELL_PX)) as i64,
