...
fn walker_places_door_set_window_and_furniture_from_fixtures() {
    ...
    let house = crate::blueprint::xob::tests::with_coll(
        wrap_xob(&synth_head(&strings, &house_nodes)),
        &crate::blueprint::xob::tests::coll_box_record_with_material(
            [0.0, 1.5, 0.0],
            [5.0, 1.5, 6.0],
            6,
            8,
    ...
    let frame = crate::blueprint::xob::tests::with_coll(
    ...
    let leaf = crate::blueprint::xob::tests::with_coll(
        wrap_xob(&synth_head(
            &[
                "Scene_Root",
                "DoorFireView",
    ...
    let win = crate::blueprint::xob::tests::with_coll(
        wrap_xob(&synth_head(
            &[
                "Scene_Root",
                "socket_glass_001",
    ...
    let glass = crate::blueprint::xob::tests::with_coll(
        wrap_xob(&synth_head(
            &[
                "Scene_Root",
                "Glass",
    ...
    let table = crate::blueprint::xob::tests::with_coll(
        wrap_xob(&synth_head(
            &[
                "Scene_Root",
                "PropFireView",
...
fn layer_policy_keeps_fire_records_and_drops_physics_shells() {
    ...
    let mut coll = crate::blueprint::xob::tests::coll_box_record_with_material(
        [0.0, 2.0, 0.0],
        [0.6, 2.0, 0.6],
        1,
        3,
    ...
    let xob =
        crate::blueprint::xob::tests::with_coll(wrap_xob(&synth_head(&strings, &[rec(0)])), &coll);
    ...
    let shell_only = crate::blueprint::xob::tests::with_coll(
