...
| **Create-over-list Dialog (T-048)** | Mission Library **+ New Mission** → `CreateMissionDialog` | [`t048_library_create_dialog.md`](../../docs/specs/Mission_Creator_Architecture/t048_library_create_dialog.md) |
