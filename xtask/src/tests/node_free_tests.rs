...
fn test_boundary_is_1000_lines_for_directory_and_basename() {
    ...
    let basename_test = d.0.join("xtask/src/fixture_tests.rs");
    ...
    assert!(is_test_file("xtask/src/fixture_tests.rs"));
    assert!(!is_test_file("xtask/src/test_helpers.rs"));
}
...
fn mc_perf_only_exempts_size_2() {
    ...
    write_lines(&d.0.join("xtask/plant.rs"), SIZE_3_PRODUCTION_MAX_LINES + 1);
