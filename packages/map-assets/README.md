...
| `{terrain}/anchors/verification.json` | yes | Engine-probed anchor log for `cargo xtask ci verify-terrain-strict` |
...
```bash
cargo xtask ci lfs-dem   # ~72 MB — hillshade + map-engine tests
cargo xtask ci lfs-sat   # ~153 MB — full satellite
