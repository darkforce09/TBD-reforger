...
| 200 | — | T-785 T-786 T-787 | PENDING | PENDING | PENDING — UX remediation band (source `.ai/artifacts/editor_hostile_ux_review.md`, briefs in registry summaries; band rules in `EDITOR_FACTORY_START.md` §UX remediation band) |
