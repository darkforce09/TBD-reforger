# Phase 3C R: inspector panels small
...
Own these files under `apps/website/frontend/src/v2/apps/editor/` (except `../debug` paths, under `v2/apps/debug/`): ui/inspector/audio_emitters.rs, ui/inspector/win_conditions_card.rs, ui/inspector/tasks_panel.rs, ui/inspector/spawn_modules.rs, ui/inspector/radio_panel.rs, ui/inspector/env.rs, ui/inspector/weather_timeline.rs, ui/inspector/vehicles_panel.rs. Own adjacent newly extracted test files and named decomposition subfolders. Do not edit any other brief's production files.
