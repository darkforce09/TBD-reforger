...
Own these files under `apps/website/frontend/src/v2/apps/editor/` (except `../debug` paths, under `v2/apps/debug/`): ui/modals/settings_modal.rs. Own adjacent newly extracted test files and named decomposition subfolders. Do not edit any other brief's production files.
