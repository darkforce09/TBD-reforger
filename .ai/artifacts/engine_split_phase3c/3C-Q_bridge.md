...
Own these files under `apps/website/frontend/src/v2/apps/editor/` (except `../debug` paths, under `v2/apps/debug/`): bridge/overlays.rs, bridge/tactical_graphics.rs, bridge/document_host/history.rs, bridge/document_host/doc_host.rs, bridge/viewport.rs, bridge/gizmo_z.rs. Own adjacent newly extracted test files and named decomposition subfolders. Do not edit any other brief's production files.
