...
Own these files under `apps/website/frontend/src/v2/apps/editor/` (except `../debug` paths, under `v2/apps/debug/`): ../debug/building_viewer.rs, ../debug/world_los.rs, ../debug/building_interior.rs, ../debug/world_los_scene.rs. Own adjacent newly extracted test files and named decomposition subfolders. Do not edit any other brief's production files.
