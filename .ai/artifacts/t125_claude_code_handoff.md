...
**Status:** queued (blocked until **T-124** ships)  
...
**T-124 shipped** — deps and toolchain on latest (Go 1.26, Node 24, Postgres 18, vitest 4).
...
| 6 | **T-125.6** | **cursor-docs** — registry shipped, hub, CLAUDE §Done |
...
```bash
make ci-local   # or equivalent once added
make test-it
