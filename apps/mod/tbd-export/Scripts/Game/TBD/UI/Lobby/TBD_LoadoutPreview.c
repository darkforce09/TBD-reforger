...
{
	//! HUD-local layout pin. T-941.3 owns TBD_UILayouts.c; do not add a constant there.
	//! TBD_UILayouts.Create strips the GUID and retries by path when the rdb has not indexed it.
	static const ResourceName LAYOUT = "{7BD1A70000000A01}UI/layouts/TBD_LoadoutPreview.layout";
