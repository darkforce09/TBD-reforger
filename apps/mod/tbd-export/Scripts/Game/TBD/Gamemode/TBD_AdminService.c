...
class TBD_AdminService
{
	...
	//! shared (see the identity note in TBD_MOD_DESIGN.md S2) and an id cannot be read back later.
	...
	//!
	//! Under ONE LIFE a death is terminal by design (TBD_MOD_DESIGN.md S2). This is the single
