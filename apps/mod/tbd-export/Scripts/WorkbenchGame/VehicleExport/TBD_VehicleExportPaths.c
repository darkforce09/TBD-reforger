/**
 * TBD_VehicleExportPaths.c
 *
 * Path normalization, directory creation, string escaping, and chunked file I/O
 * for the TBD Workbench Vehicle Data Exporter.
 */

class TBD_VehicleExportPaths
{
	//------------------------------------------------------------------------------------------------
	...
	{
		if (dir.IsEmpty())
			return "$profile:TBD_Export/vehicles/";
...
//! JSON writing and string escaping helpers for vehicle export.
class TBD_VehicleExportJson
{
	//------------------------------------------------------------------------------------------------
