//------------------------------------------------------------------------------------------------
// TBD_HandguardModel.c
//
// Strong data models representing weapon handguards, rail systems, and foregrips for the
...
//   - ZERO token mutation: raw engine localization strings (e.g. #AR-Item_Handguard_M16A2_Name)
...
//   - NESTED ATTACHMENT HOST: modular handguards declare child slots (top rail, bottom rail, side rails)
//     hosting optics, underbarrel launchers, foregrips, and illuminators.
//------------------------------------------------------------------------------------------------

class TBD_HandguardMountingInfo
{
...
class TBD_HandguardHandlingInfo
{
...
class TBD_HandguardPhysicalInfo
{
...
class TBD_HandguardVisualsInfo
{
	string m_sModelMesh;
}

class TBD_HandguardInfo
{
	...
	ref TBD_HandguardMountingInfo m_Mounting = new TBD_HandguardMountingInfo();
	ref array<ref TBD_HandguardSlotInfo> m_aNestedSlots = {};
	ref TBD_HandguardHandlingInfo m_Handling = new TBD_HandguardHandlingInfo();
	ref TBD_HandguardPhysicalInfo m_Physical = new TBD_HandguardPhysicalInfo();
	ref TBD_HandguardVisualsInfo m_Visuals = new TBD_HandguardVisualsInfo();

	//------------------------------------------------------------------------------------------------
	//! Serialize handguard device entry to clean, indented JSON string strictly adhering to Target Data Schema
	string SerializeJson(string indent = "    ")
	{
		string json = indent + "{\n";
		string sub = indent + "  ";
		...
		// 3. Nested Attachment Slots (child slots hosted by this handguard)
