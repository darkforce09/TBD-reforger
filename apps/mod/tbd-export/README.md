...
| `Scripts/WorkbenchGame/EquipmentExport/**` | Equipment diagnostic entry points using the shared source pipeline. |
| `Scripts/WorkbenchGame/EquipmentVehicleExport/**` | Versioned equipment and vehicle source extraction, verification, snapshots and isolated generations. [README](Scripts/WorkbenchGame/EquipmentVehicleExport/README.md). |
| `Scripts/WorkbenchGame/VehicleExport/**` | Vehicle diagnostic entry points using the shared source pipeline. |
