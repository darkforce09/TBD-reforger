...
pub use entity::{
    ...
    begin_layer_comment_drag, begin_layer_drag, begin_layer_slot_drag, begin_place,
    begin_place_composition, begin_place_marker, begin_place_object, begin_place_vehicle,
    begin_refile, begin_zone_draw, begin_zone_reshape, cancel_connect, cancel_layer_drag,
    cancel_pending, cancel_refile, cancel_zone_draw, census_input, center_on_selection,
    clear_crew_seat, close_zone_polygon, comment_count, comment_details, comment_list,
    complete_connect, complete_layer_drop_onto_folder, complete_layer_drop_onto_root,
    complete_refile_onto_squad, connection_exists, connection_findings, connection_list,
    copy_selection, create_layer, crewed_slot_ids, debug_seed_slots, delete_comment,
    delete_connection, delete_layer, delete_trigger, delete_zone, document_entities,
    duplicate_comment, faction_doc_from_side, force_to_formation, has_pending, hide_selection,
    is_vehicle_id, marker_count, marker_rows, move_comment, move_vehicles, orbat_add_slot,
    orbat_add_squad, orbat_add_vehicle, orbat_apply_faction, orbat_manager_snapshot,
    orbat_remove_slot, orbat_remove_squad, orbat_rename_squad, orbat_set_leader,
    orbat_update_slot_fields, owner_line_world, pending_connect, place_at, place_at_alt,
    place_at_keep, place_comment, placed_owner_options, placed_slot_choices, read_comment,
    refile_comment_to_layer, refile_slot, refile_slot_to_layer, regroup_slot_onto, remove_marker,
    remove_vehicle, rename_comment, rename_layer, reparent_layer, select_all_in_view,
    select_layer_children, select_layer_descendants, select_slot, selection_entities,
    selection_len, set_active_layer, set_comment_tooltip, set_layer_hidden, set_layer_locked,
    set_marker_icon, set_marker_label, set_marker_position, set_selection_ids,
    ...
    zone_draft, zone_draw_armed, zone_draw_pop_vertex, zone_rows, CommentDetail,
    ConnectionFindingRow, ConnectionListRow, MarkerRow, OrbatManagerSnapshot, OrbatSlotDetail,
