...
//! `select_tool`, `editor_ops`) keep importing from `crate::editor::eden_chrome::*` unchanged — the split
...
// These re-exports are all consumed through `crate::editor::eden_chrome::*` on the wasm build; on the native
...
// [`crate::editor::layout`], which owns them.
pub use crate::editor::layout::{DOCK_LEFT_PX, DOCK_RIGHT_PX, STRIP_TOP_PX, TOOLBELT_BAND_PX};

// The four docked components + the Mission Settings dialog `mission_editor` mounts.
pub use crate::editor::panels::dock_left::DockLeft;
pub use crate::editor::panels::dock_right::DockRight;
pub use crate::editor::panels::settings_modal::MissionSettingsDialog;
pub use crate::editor::panels::toolbelt::BottomToolbelt;
pub use crate::editor::panels::top_strip::TopCommandStrip;
...
// these through `crate::editor::eden_chrome`, so they stay re-exported here; they live in
// [`crate::editor::panels::zones_panel`].
pub use crate::editor::panels::zones_panel::{
