...
///
/// Deliberately *not* [`crate::v2::core::api::dto::EventListItem`]: that DTO models the whole schedule card
...
impl EventOption {
    ...
    ///
    /// Deliberately **not** including the date: `crate::v2::core::utils::datefmt` is `js_sys::Date` all the way
