...
//! `select_tool`, `editor_ops`) keep importing from `crate::v2::apps::editor::eden_chrome::*` unchanged — the split
...
// These re-exports are all consumed through `crate::v2::apps::editor::eden_chrome::*` on the wasm build; on the native
...
// [`crate::v2::apps::editor::layout`], which owns them.
pub use crate::v2::apps::editor::layout::{
...
// these through `crate::v2::apps::editor::eden_chrome`, so they stay re-exported here; they live in
