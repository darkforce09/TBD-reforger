...
[mission](/documentation_v2/glossary/g_to_m.md#mission): they read the hosted document and upload the
...
- Rules: every [slot](/documentation_v2/glossary/n_to_z.md#slot) rebind passes the role column from
