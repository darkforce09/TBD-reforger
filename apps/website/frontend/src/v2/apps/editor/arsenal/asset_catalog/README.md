...
- [Mission Creator feature inventory](/documentation_v2/website/frontend/apps/editor/feature_inventory/README.md#right--asset-palette)
  — the asset palette these trees fill.
