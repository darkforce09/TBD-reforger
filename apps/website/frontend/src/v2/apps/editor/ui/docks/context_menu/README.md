...
The right-click menu over the [Mission Creator](/documentation_v2/glossary/g_to_m.md#mission-creator)'s
...
A right-click on the canvas picks the [slot](/documentation_v2/glossary/n_to_z.md#slot) or vehicle under
...
formations of the [mission](/documentation_v2/glossary/g_to_m.md#mission) schema's
...
[arsenal](/documentation_v2/glossary/a_to_f.md#arsenal) or the connections panel, places a comment in the
