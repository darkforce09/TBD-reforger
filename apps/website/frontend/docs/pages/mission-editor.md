...
> **Legacy mirror** — canonical doc: [`docs/website/frontend/pages/mission-editor.md`](../../../../docs/website/frontend/pages/mission-editor.md). Edit the canonical copy first; keep this file in sync.
...
- **Blocked / in progress:** **T-090** map visualization program (rewritten to constants N1–N12, 2026-06-30) — **T-090.0.2** map-object schemas + goldens + verify **shipped**; **T-090.3.0** Workbench export spike **active**; **T-090.1/.1.1** Satellite + Map basemap switch (synthesized fallback, N9); **T-090.2** taxonomy (+ forest/field/water regions); **T-090.3** export; **T-090.4/.6/.8** Z/geometry audits + **forest regions**; **T-090.5** Deck-orthographic-zoom render; **T-090.9** world-object hover/inspect/filter/legend (**read-only**); **T-090.7** Eden AI read API. **T-091 shipped** @ `dde589e`. **Basemap today:** procedural grid + hillshade. **Spawn gate:** **T-092**. **T-068** Phase 2 paused. **T-126** floor picker deferred (outside T-090). Hub + Audit closure: [`t090_091_map_terrain_program.md`](../../../specs/Mission_Creator_Architecture/t090_091_map_terrain_program.md).
...
- **Active slice:** **T-090.3.0** — Workbench export spike ([`t090_3_0_workbench_export_spike.md`](../../../specs/Mission_Creator_Architecture/t090_3_0_workbench_export_spike.md)); **T-090.1** aligned basemap **queued** until 3.0 K1–K7 PASS. **T-090 program** (`.2` taxonomy → `.5` render → `.9` interaction): [`t090_091_map_terrain_program.md`](../../../specs/Mission_Creator_Architecture/t090_091_map_terrain_program.md). **T-091 shipped** @ `dde589e`.
