...
**Doc hub:** [docs/frontend/ROADMAP.md](../../docs/frontend/ROADMAP.md) · **Mission Creator:** [ROADMAP.md](../../docs/specs/Mission_Creator_Architecture/ROADMAP.md) · **Tickets:** [TICKET_LEAD.md](../../docs/TICKET_LEAD.md)
...
| [auth/auth-callback.md](auth/auth-callback.md) | `/auth/callback` | doc-complete | — | T-002 (shipped) |
| [pages/dashboard.md](pages/dashboard.md) | `/` | doc-complete | — | — |
| [pages/server-intel.md](pages/server-intel.md) | `/server-intel` | doc-complete | §4.1 | T-088 |
...
| [pages/mission-editor.md](pages/mission-editor.md) | `/missions/:id/edit` | in-progress | — | T-068.5 active (mod equip); T-068.4 loadout UI shipped |
...
| [pages/wiki.md](pages/wiki.md) | `/wiki` | doc-complete | §4.6 | T-085 |
...
| [pages/server-control.md](pages/server-control.md) | `/admin/server` | doc-complete | §2.B | T-086 |
| [pages/personnel-roster.md](pages/personnel-roster.md) | `/admin/personnel` | doc-complete | §4.10 | shipped |
