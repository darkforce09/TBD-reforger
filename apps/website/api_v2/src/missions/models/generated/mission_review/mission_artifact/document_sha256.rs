...
///`MissionArtifactDocumentSha256`
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct MissionArtifactDocumentSha256(::std::string::String);
impl ::std::ops::Deref for MissionArtifactDocumentSha256 {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<MissionArtifactDocumentSha256> for ::std::string::String {
    fn from(value: MissionArtifactDocumentSha256) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for MissionArtifactDocumentSha256 {
...
impl ::std::convert::TryFrom<&str> for MissionArtifactDocumentSha256 {
...
impl ::std::convert::TryFrom<&::std::string::String> for MissionArtifactDocumentSha256 {
    type Error = super::super::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for MissionArtifactDocumentSha256 {
