...
///`MissionArtifactMetadataSha256`
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct MissionArtifactMetadataSha256(::std::string::String);
impl ::std::ops::Deref for MissionArtifactMetadataSha256 {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<MissionArtifactMetadataSha256> for ::std::string::String {
    fn from(value: MissionArtifactMetadataSha256) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for MissionArtifactMetadataSha256 {
...
impl ::std::convert::TryFrom<&str> for MissionArtifactMetadataSha256 {
...
impl ::std::convert::TryFrom<&::std::string::String> for MissionArtifactMetadataSha256 {
    type Error = super::super::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for MissionArtifactMetadataSha256 {
