...
///`MissionArtifactArtifactDigest`
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct MissionArtifactArtifactDigest(::std::string::String);
impl ::std::ops::Deref for MissionArtifactArtifactDigest {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<MissionArtifactArtifactDigest> for ::std::string::String {
    fn from(value: MissionArtifactArtifactDigest) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for MissionArtifactArtifactDigest {
...
impl ::std::convert::TryFrom<&str> for MissionArtifactArtifactDigest {
...
impl ::std::convert::TryFrom<&::std::string::String> for MissionArtifactArtifactDigest {
    type Error = super::super::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for MissionArtifactArtifactDigest {
