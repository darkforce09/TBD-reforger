...
///`MissionDeploymentScenarioId`
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct MissionDeploymentScenarioId(::std::string::String);
impl ::std::ops::Deref for MissionDeploymentScenarioId {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<MissionDeploymentScenarioId> for ::std::string::String {
    fn from(value: MissionDeploymentScenarioId) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for MissionDeploymentScenarioId {
...
impl ::std::convert::TryFrom<&str> for MissionDeploymentScenarioId {
...
impl ::std::convert::TryFrom<&::std::string::String> for MissionDeploymentScenarioId {
    type Error = super::super::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for MissionDeploymentScenarioId {
