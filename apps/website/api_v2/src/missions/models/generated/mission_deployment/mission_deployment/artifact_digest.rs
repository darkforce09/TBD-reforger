...
///`MissionDeploymentArtifactDigest`
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct MissionDeploymentArtifactDigest(::std::string::String);
impl ::std::ops::Deref for MissionDeploymentArtifactDigest {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<MissionDeploymentArtifactDigest> for ::std::string::String {
    fn from(value: MissionDeploymentArtifactDigest) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for MissionDeploymentArtifactDigest {
...
impl ::std::convert::TryFrom<&str> for MissionDeploymentArtifactDigest {
...
impl ::std::convert::TryFrom<&::std::string::String> for MissionDeploymentArtifactDigest {
    type Error = super::super::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for MissionDeploymentArtifactDigest {
