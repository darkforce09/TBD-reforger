...
///`MissionDeploymentArtifactSha256`
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[serde(transparent)]
pub struct MissionDeploymentArtifactSha256(::std::string::String);
impl ::std::ops::Deref for MissionDeploymentArtifactSha256 {
    type Target = ::std::string::String;
    fn deref(&self) -> &::std::string::String {
        &self.0
    }
}
impl ::std::convert::From<MissionDeploymentArtifactSha256> for ::std::string::String {
    fn from(value: MissionDeploymentArtifactSha256) -> Self {
        value.0
    }
}
impl ::std::str::FromStr for MissionDeploymentArtifactSha256 {
...
impl ::std::convert::TryFrom<&str> for MissionDeploymentArtifactSha256 {
...
impl ::std::convert::TryFrom<&::std::string::String> for MissionDeploymentArtifactSha256 {
    type Error = super::super::error::ConversionError;
    fn try_from(
...
impl<'de> ::serde::Deserialize<'de> for MissionDeploymentArtifactSha256 {
