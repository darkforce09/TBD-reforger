...
/// not non-emptiness, and `0.0` must stay
...
/// `wiki_pages.slug` in [`crate::community_content::handlers::wiki_knowledgebase`]. The difference is
/// that a grid reference is matched by
