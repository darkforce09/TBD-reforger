//! Role: vectors tests.
//! Position: `terrain/water/tests` in the graphics engine.
//! Signals & state: camera, spatial, asset, or GPU data owned by this module.
//! Invariants: preserve coordinates, resource lifetimes, ordering, and binary layouts.

use crate::formats::archives::codec::to_bytes;
use crate::formats::archives::water::WaterBody;
use crate::formats::archives::water::WaterLine;
use crate::formats::containers::header::HEADER_BYTES;
use crate::terrain::water::vectors::*;
