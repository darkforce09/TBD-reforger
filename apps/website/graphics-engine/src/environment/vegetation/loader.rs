...
use crate::environment::vegetation::density::CHUNKS_PER_AXIS;
use crate::environment::vegetation::density::EVERON_DENSITY_BINS;
use crate::environment::vegetation::density::ISLAND_CORNERS;
use crate::environment::vegetation::density::pack_island_r8_yflip;
use crate::environment::vegetation::density::stitch_chunk_into_island;
use crate::environment::vegetation::mass::CANOPY_MASS_ISO;
use crate::environment::vegetation::mass::forest_fill_alpha;
use crate::environment::vegetation::mass::forest_outline_segments_from_corners;
use crate::formats::density::tbdd::decode_tbdd;
    ...
    async fn boot_upload(
...

        {
            ...
            e.upload_hairline_segments(
                crate::core::pipeline::draw_order::role_id::FOREST_OUTLINE,
                &hair.verts,
                hair.segment_count,
                false,
            );
