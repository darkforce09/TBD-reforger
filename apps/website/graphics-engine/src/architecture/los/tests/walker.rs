...
use crate::architecture::compound::assembly::FlatMesh;
...
use crate::architecture::los::walker::*;
use crate::architecture::los::wash::WashParams;
use crate::architecture::los::wash::compound_wash;
...
use crate::spatial::terrain_los::viewshed::Visibility;
...
fn flatten_bakes_instances_with_owners_and_owned_cuts_tag_the_leaf() {
    ...
    let plain = crate::architecture::section::cutter::section_at(&flat.mesh, 1.2, 0.35);
...
fn wash_sees_through_an_open_door_and_through_glass_but_not_a_frame() {
    ...
    let mut c = room_with_door(90.0);
    let obs = [0.0, 1.2, 8.0];
    let behind_door = |w: &crate::architecture::los::wash::LevelWash| w.visibility_at(0.0, 3.0);
