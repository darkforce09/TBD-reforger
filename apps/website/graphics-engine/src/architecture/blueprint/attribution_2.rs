...
use crate::architecture::blueprint::attribution_1::APERTURE_SLACK_M;
use crate::architecture::blueprint::attribution_1::LosHit;
use crate::architecture::blueprint::attribution_1::LosHitKind;
use crate::architecture::blueprint::geometry::dist_2d;
use crate::architecture::blueprint::geometry::point_at;
use crate::architecture::blueprint::geometry::segment_aabb_entry_t_2d;
use crate::architecture::blueprint::geometry::segment_intersection_t_2d;
