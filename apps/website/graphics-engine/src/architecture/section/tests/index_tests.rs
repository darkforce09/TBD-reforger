//! Role: index tests.
//! Position: `architecture/section/tests` in the graphics engine.
...
use crate::architecture::section::cutter::CUT_MAX_NY;
use crate::architecture::section::cutter::HeightField;
use crate::architecture::section::cutter::MAX_PLAN_DIM;
use crate::architecture::section::cutter::PLAN_CELL_M;
use crate::architecture::section::cutter::Seg2;
use crate::architecture::section::cutter::VOID_PAD_M;
use crate::architecture::section::cutter::mesh_bounds;
use crate::architecture::section::cutter::section_at_owned;
use crate::architecture::section::index::*;
