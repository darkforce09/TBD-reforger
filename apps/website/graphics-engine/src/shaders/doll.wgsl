//! Role: mannequin vertex transformation and Lambert-plus-ambient shading.
//! Position: shaders consumed by the doll renderer.
//! Signals & state: camera uniform, instance transforms, colors, and normals.
//! Invariants: flat shading preserves byte-exact colors for readback probes.
// params.x > 0.5 switches
