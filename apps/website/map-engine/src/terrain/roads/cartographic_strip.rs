...
use crate::terrain::roads::styling::StripVertex;
use crate::terrain::roads::styling::expand_polyline_strip;
use crate::terrain::roads::styling::norm_rgba;
use crate::terrain::roads::styling::pack_strip_verts;
...
pub fn obb_long_axis_endpoints(
    ...
    let c = crate::environment::buildings::obb::obb_corners(x, y, half_x, half_y, rotation_deg);
