...
use crate::symbology::instances::drag::DragGpuPhase;
use crate::symbology::instances::drag::classify_drag_transition;
use crate::symbology::instances::patches::selected_row_patch;
use crate::symbology::instances::patches::unselected_row_patch_for;
use crate::symbology::instances::symbols::SLOT_ICON_STRIDE;
use crate::symbology::instances::symbols::pack_cluster_instances;
...
impl RenderEngine {
    ...
    pub fn ensure_slot_atlas(
        ...
        match crate::symbology::atlas::raster::extend_atlas_with_unit_glyphs(rgba, width, height) {
            Some(wide) => {
...
impl RenderEngine {
    ...
    pub(crate) fn slot_m_per_px(&self) -> f32 {
        crate::symbology::instances::symbols::px_to_m_at_zoom(self.zoom())
    }
}
...
impl RenderEngine {
    ...
    pub(crate) fn symbology_detailed(&self) -> bool {
        crate::symbology::instances::symbols::symbology_visible(self.slot_m_per_px())
    }
}
...
impl RenderEngine {
    ...
    pub fn slots_bind_symbology(
        ...
        self.slot_bridge.last_cluster_mode =
            crate::symbology::instances::symbols::cluster_mode(n, zoom);
...
impl RenderEngine {
    ...
    pub(crate) fn feed_cluster_markers(&mut self) {
        ...
        #[allow(clippy::cast_possible_truncation)]
        if !crate::symbology::instances::symbols::cluster_mode(n as u32, self.zoom()) {
    ...
    pub fn set_selection(&mut self, ids: Vec<String>) {
        ...
        for (row, now) in &flips {
            ...
            let patch = match self.slot_bridge.symbology_base {
                Some(base) => crate::symbology::instances::patches::symbology_row_patch(
                    *now,
                    self.slot_bridge
                        .last_roles
                        .get(*row)
