//! Role: draw order.
//! Position: `overlay/tests` in the graphics engine.
//! Signals & state: camera, spatial, asset, or GPU data owned by this module.
//! Invariants: preserve coordinates, resource lifetimes, ordering, and binary layouts.

use crate::overlay::lanes::ALL_LANES;
use crate::overlay::lanes::LaneRole as L;
use crate::overlay::lanes::lane_order;
use crate::overlay::lanes::lane_role_from_u32;
use crate::overlay::lanes::lane_role_to_u32;
...
fn wire_round_trip_is_exhaustive_both_ways() {
    ...
    for role in ALL_LANES {
        match lane_role_to_u32(role) {
            ...
            None => assert!(
                !(0..=crate::overlay::lanes::role_id::MAX)
    ...
    assert_eq!(
        with_id,
        usize::try_from(crate::overlay::lanes::role_id::MAX).unwrap() + 1
    );
    assert_eq!(
        with_id, 24,
...
fn unknown_role_ids_are_none_not_a_panic() {
    for id in [
        crate::overlay::lanes::role_id::MAX + 1,
        crate::overlay::lanes::role_id::MAX + 2,
        24,
        99,
        256,
        65_536,
...
fn wire_ids_are_pinned() {
    ...
    assert_eq!(crate::overlay::lanes::role_id::SEA, 0);
    assert_eq!(crate::overlay::lanes::role_id::SQUAD_LINKS, 9);
    assert_eq!(crate::overlay::lanes::role_id::MISSION_ZONES, 10);
    assert_eq!(crate::overlay::lanes::role_id::INTERIOR_SLABS, 11);
    assert_eq!(crate::overlay::lanes::role_id::INTERIOR_PROBE, 23);
    assert_eq!(crate::overlay::lanes::role_id::MAX, 23);
}
...
fn tex_wire_ids_are_pinned() {
    ...
    assert_eq!(crate::overlay::lanes::tex_role_id::BASEMAP, 0);
    assert_eq!(crate::overlay::lanes::tex_role_id::HILLSHADE, 1);
    assert_eq!(crate::overlay::lanes::tex_role_id::MAX, 1);
...
fn unknown_tex_role_ids_are_none_not_hillshade() {
    for id in [
        crate::overlay::lanes::tex_role_id::MAX + 1,
        crate::overlay::lanes::tex_role_id::MAX + 2,
        crate::overlay::lanes::role_id::MISSION_ZONES,
        7,
        99,
        u32::MAX,
    ] {
...
fn probe_sits_between_viewshed_and_grid() {
    ...
    assert_eq!(
        ...
        Some(crate::overlay::lanes::role_id::INTERIOR_PROBE)
    );
}
