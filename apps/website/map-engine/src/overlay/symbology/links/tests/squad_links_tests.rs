...
//! Position: `overlay/symbology/links/tests` in the graphics engine.
//! Signals & state: camera, spatial, asset, or GPU data owned by this module.
//! Invariants: preserve coordinates, resource lifetimes, ordering, and binary layouts.

use crate::overlay::symbology::links::squad_links::*;
use crate::overlay::symbology::roles::classify::SIDE_OPFOR_RGBA;
