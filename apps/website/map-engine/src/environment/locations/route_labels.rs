...
use crate::environment::locations::route_placement::ROAD_CLASSES;
use crate::environment::locations::route_placement::ROAD_NAME_MIN_ZOOM_SECONDARY;
use crate::environment::locations::route_placement::RoadLabelPlacement;
use crate::environment::locations::route_placement::declutter_road_labels_in_order;
use crate::environment::locations::route_placement::place_road_labels;
use crate::environment::locations::route_placement::road_class_code;
use crate::environment::locations::route_placement::road_class_name;
use crate::environment::locations::route_placement::road_class_priority;
use crate::environment::locations::route_placement::road_class_visibility_floor;
use crate::environment::locations::route_placement::road_declutter_order;
use crate::environment::locations::route_placement::road_name_visible_for_class;
...
pub fn road_names_to_archive(
...
) -> Result<Vec<crate::formats::archives::labels::RoadNameLabel>, String> {
    let bake_zoom = names
        .roads
        .iter()
    ...
    Ok(baked
        .into_iter()
        .map(
            |(p, code)| crate::formats::archives::labels::RoadNameLabel {
                name: p.name,
...
pub fn road_names_from_archive(
    archive: &rkyv::Archived<crate::formats::archives::labels::MapLabelsArchive>,
