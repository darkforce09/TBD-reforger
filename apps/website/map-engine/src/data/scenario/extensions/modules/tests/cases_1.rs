...
//! Position: `mission/extensions/modules/tests` in the map engine's headless mission data domain.
...
fn spawn_modules_is_registered_on_the_carrier() {
    ...
    assert!(
        !crate::data::scenario::extensions::DOCUMENT_OWNED_BLOCKS.contains(&"spawnModules"),
