...
The check on a [mission](/documentation_v2/glossary/g_to_m.md#mission)'s authored `radioPlan` block: the
...
earlier net. The net and label limits are where the [mod](/documentation_v2/glossary/g_to_m.md#mod)
...
[ORBAT](/documentation_v2/glossary/n_to_z.md#orbat). In the game,
...
- Used by: `crate::data::scenario::extensions`, whose `radioPlan` row calls `validate` and whose
  ...
  into the compiled plan; the [Mission Creator](/documentation_v2/glossary/g_to_m.md#mission-creator)'s
