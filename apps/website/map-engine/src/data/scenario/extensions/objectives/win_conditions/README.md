# src/mission/extensions/objectives/win_conditions

win conditions parsing, validation, and domain projections. The Rust module is the source of truth for supported fields and behavior.
