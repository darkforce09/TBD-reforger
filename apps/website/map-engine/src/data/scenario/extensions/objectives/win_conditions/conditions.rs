//! Role: conditions.
//! Position: `mission/extensions/objectives/win_conditions` in the map engine's headless mission data domain.
...
/// [`parse`] with the value discarded — the [`crate::data::scenario::extensions::AUTHORED_BLOCKS`] row's validator, which needs the verdict and not the parse.
