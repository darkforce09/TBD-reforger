# src/mission/extensions/objectives/tasks

tasks parsing, validation, and domain projections. The Rust module is the source of truth for supported fields and behavior.
