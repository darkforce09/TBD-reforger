...
#[derive(Debug, Serialize)]
pub struct ModNet {
    /// `^net:[a-z0-9_]+$`. Unique within the document — the mod treats it as the stable channel key and the VOIP bridge keys voice channels on it (`documentation_v2/contracts_v2/definitions/bridge_messages.md` §radioPlan → voice net mapping).
    pub id: String,
