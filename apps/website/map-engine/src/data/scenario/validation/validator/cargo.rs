...
pub(super) fn rule_cargo_over_capacity() -> Rule {
    Rule {
        ...
        eval: |rule, payload, ctx| {
            ...
            let lines = crate::data::scenario::wire_safety::scan_cargo_capacity(payload, catalog);
        ...
        trip_context: || {
            let mut catalog = crate::data::scenario::wire_safety::CargoPhysCatalog::new();
            catalog.insert(
                "mag".to_string(),
                crate::data::scenario::wire_safety::CargoPhys {
                    display_name: "Mag".to_string(),
                    weight_kg: Some(0.5),
                    volume_cm3: Some(60.0),
                    ..crate::data::scenario::wire_safety::CargoPhys::default()
                },
            );
            catalog.insert(
                "vest_rn".to_string(),
