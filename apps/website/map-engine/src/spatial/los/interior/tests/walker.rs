//! Role: walker.
//! Position: `spatial/los/interior/tests` in the graphics engine.
...
use crate::spatial::los::interior::walker::*;
use crate::spatial::los::interior::wash::WashParams;
use crate::spatial::los::interior::wash::compound_wash;
use crate::spatial::los::terrain::viewshed::Visibility;
use crate::world::architecture::compound::assembly::CompoundError;
use crate::world::architecture::compound::assembly::CoverTier;
use crate::world::architecture::compound::assembly::FlatMesh;
...
fn flatten_bakes_instances_with_owners_and_owned_cuts_tag_the_leaf() {
    ...
    let plain = crate::world::architecture::section::cutter::section_at(&flat.mesh, 1.2, 0.35);
...
fn wash_sees_through_an_open_door_and_through_glass_but_not_a_frame() {
    ...
    let obs = [0.0, 1.2, 8.0];
    let behind_door =
        |w: &crate::spatial::los::interior::wash::LevelWash| w.visibility_at(0.0, 3.0);
