# src/mission/extensions/environment/audio

audio parsing, validation, and domain projections. The Rust module is the source of truth for supported fields and behavior.
