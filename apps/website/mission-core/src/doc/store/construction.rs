...
impl MissionDocCore {
    ...
    pub(super) fn from_doc(doc: Doc) -> Self {
        Self::from_doc_with_clock(doc, crate::doc::crdt::undo_groups::default_inner_clock())
    }
}
...
impl MissionDocCore {
    ...
    pub(super) fn from_doc_with_clock(doc: Doc, inner_clock: Arc<dyn yrs::sync::Clock>) -> Self {
        ...
        let undo_groups = crate::doc::crdt::undo_groups::GroupingClock::wrap(inner_clock);
        let opts = crate::doc::crdt::undo_groups::undo_options(
            undo_groups.clone(),
