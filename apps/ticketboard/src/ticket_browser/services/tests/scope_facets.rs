use super::*;
use crate::test_support::{Scratch, corpus_of, program, work_scoped};
use crate::ticket_browser::services::filtering::FilterIndex;
...
/// acceptance fixture: selecting domain=website narrows the layer
