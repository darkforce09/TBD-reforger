...
| T-544 | 3384 | running | platform | T-532 Class-R only — no HTTP IT for set-current version re-point | FOUND by W54 adversarial verifier (CLEAN MINOR-NIT) after T-532.
...
| T-545 | 3385 | running | platform | mcp-daemon.sh comment still claims mcpd-bin ignores CARGO_TARGET_DIR | FOUND by W55 adversarial verifier (CLEAN MINOR-NIT) after T-543.
