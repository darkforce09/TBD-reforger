...
| T-151 | 1500 | ready | Platform | WebGPU (wgpu/wasm) render engine spike - replace Deck.gl | wgpu Mission Creator engine program (spike SHIPPED; W0–W5 + T-151.5.1 shipped @ a98fb421; T-151.6 mission entities ready). Hub: t151_wgpu_engine_program.md. Execution: standing worktree tbd-reforger-wgpu-spike/ only; manual Claude prompts. |
