...
| T-069 | 690 | queued | eden | Markers on map | Post-audit markers: addMarker + wgpu render/select/move/delete. Audit+remediations shipped (T-151.10…T-151.11.6). Still queued pending operator sign-off and/or polish slice. Spec: t069_markers_on_map.md. Worktree tbd-reforger-wgpu-spike/. |
