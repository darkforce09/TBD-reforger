...
| T-151 | 1500 | ready | Platform | WebGPU (wgpu/wasm) render engine spike - replace Deck.gl | wgpu Mission Creator engine program (spike SHIPPED; W0–W7 shipped @ ab6bcb11; T-151.7.1 interaction hotfix ready — selection tint / drag FPS / zoom-at-cursor). Hub: t151_wgpu_engine_program.md. Execution: standing worktree tbd-reforger-wgpu-spike/ only; manual Claude prompts. |
