...
| T-946 | — | idea | work | Wave close: child tickets, ledger-seated labels, batch ship | wave --close could not close any wave: the close-time view saw parent tickets only, lock labels ran past what the marker oracle accepts, and per-id repacks stopped a wave ever emptying. |
