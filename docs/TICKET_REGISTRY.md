...
| T-408 | 3224 | running | platform | Two non-URL injection/authz gaps found during the T-391 sweep | Both found while auditing URL sinks; neither is a URL problem, so neither belongs in T-405. Reported by T-391's slice agent, not fixed.
