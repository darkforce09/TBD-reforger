...
| T-152 | 1520 | ready | infra | Map cartographic fidelity (glyphs, text, labels) | Map cartographic fidelity — remediation ladder: T-152.15 shipped (fences/piers/bridges); active T-152.16 height markers visible. Hub: t152_map_cartographic_fidelity_program.md. |
