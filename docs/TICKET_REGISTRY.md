...
| T-525 | 3365 | running | platform | content_golden.sql obsolete two-seat / index-deferred comments after T-511 | Wave 46 verifier NIT. apps/website/api/seeds/content_golden.sql ~655–656 still says orbat assigned partial unique deferred / events.rs still seeds two-seat — obsolete after 0017 + T-511 seed retirement. Cure: update seed comments to match live index. |
...
| T-550 | 3390 | running | platform | Events roster still compiles with empty CargoPhysCatalog (T-549 residual) | FOUND by W59 adversarial verifier (CLEAN MINOR outside owns) after T-549.
