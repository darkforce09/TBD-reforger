...
| T-090 | 900 | ready | infra | Map visualization program | Map Engine v2 — A3-structural pivot (data+vectors, not raster compose). **Active:** **T-090.10.1** plan. **Cancelled:** .1.2.9, .1.2.3. **Frozen:** map pyramid compose. Authority: t090_10_map_engine_v2.md · T-144.1 @ b1949182. |
