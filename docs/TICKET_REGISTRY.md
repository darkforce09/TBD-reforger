...
| T-155 | 1550 | idea | platform | Mission Create visual overhaul | Visual map picker with thumbnails, modset selection, remove time/weather/max players from menu. |
| T-156 | 1560 | idea | eden | Editor shell UX consolidation | Consolidate Settings buttons, wire up top bar, remove redundant Assets tab. |
