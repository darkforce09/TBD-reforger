...
| T-151 | 1500 | ready | Platform | WebGPU (wgpu/wasm) render engine spike - replace Deck.gl | wgpu Mission Creator engine program (spike SHIPPED; W0–W7.2 shipped @ 69ca1c08; T-151.7.3 Rust collapse ready — move slot GPU bridge out of TypeScript). Hub: t151_wgpu_engine_program.md. Execution: standing worktree tbd-reforger-wgpu-spike/ only; manual Claude prompts. |
