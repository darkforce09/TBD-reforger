...
| T-151 | 1500 | ready | Platform | WebGPU (wgpu/wasm) render engine spike - replace Deck.gl | wgpu Mission Creator engine program (spike SHIPPED @ 94261dd6; W0/T-151.0 @ f019512d; W1/T-151.1 @ 3ab81587 — basemap TBDS/hillshade/grid on wgpu; verify .ai/artifacts/t151_1_verify_log.md). Slices W2-W9 wire world data, all render layers, and editor interaction onto the engine; Deck stays the oracle until T-151.9. Hub: t151_wgpu_engine_program.md. Execution: standing worktree tbd-reforger-wgpu-spike/ only; manual Claude prompts; no per-slice branches or ticket run. |
