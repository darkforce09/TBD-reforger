...
| T-069 | 690 | ready | eden | Markers on map | W10 first slice: addMarker + wgpu render/select/move/delete for MapMarker kinds (line/arrow/phase/icon/polygon). Unlocked by T-151.9. Hub W10. Spec: t069_markers_on_map.md. Worktree tbd-reforger-wgpu-spike/. |
...
| T-151 | 1500 | shipped | Platform | WebGPU (wgpu/wasm) render engine spike - replace Deck.gl | wgpu Mission Creator engine program COMPLETE (W0–W9). Deck runtime retired @ c4831451 (tag T-151.9). Hub: t151_wgpu_engine_program.md. Worktree tbd-reforger-wgpu-spike/. D5 LANGUAGE GATE. W10 = T-069+. |
