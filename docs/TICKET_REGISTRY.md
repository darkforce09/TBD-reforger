...
| T-696 | 4500 | queued | eden | Map bookmarks and a named-locations index | NEW-F7 + 3den E1. The cheapest large win in the 3den sweep: a 12.8 km map with zero bookmarks today. TBD ALREADY HAS THE DATA for the locations half — world_assets/labels.rs and the Town labels layer (world_layer_prefs.rs) carry named places; nothing lets you list or fly to one. Eden has a Locations tab beside Entities. |
