...
| T-415 | 3240 | running | platform | The mod never checks whether it delivered the authored loadout, and IsComplete has zero callers | THE DURABLE FIX for T-240, which shipped the client half only. Confirmed twice by independent agents on 2026-07-26, and re-confirmed against the source during wave 4.
