...
| T-150 | 1460 | queued | eden | Enfusion Asset Data Exporter Plugin | Extract vehicles, weapons, uniforms, and ammo to JSON. Critical: Must parse vehicle turrets to trace compatible magazine/ammo types so the web UI knows exactly what fits. Skip static objects (sandbags, fences). |
...
| T-151 | 1500 | ready | Platform | WebGPU (wgpu/wasm) render engine spike - replace Deck.gl | wgpu Mission Creator engine program (spike SHIPPED @ 94261dd6; W0/T-151.0 @ f019512d; W1/T-151.1 @ 3ab81587; W2/T-151.2 @ a51e9dcb; W3/T-151.3 @ 32bf5ac5 — residency + building GPU on wgpu; verify .ai/artifacts/t151_3_verify_log.md). Slices W4-W9 wire vector layers and editor interaction onto the engine; Deck stays the oracle until T-151.9. Hub: t151_wgpu_engine_program.md. Execution: standing worktree tbd-reforger-wgpu-spike/ only; manual Claude prompts; no per-slice branches or ticket run. |
