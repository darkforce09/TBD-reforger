...
| T-934 | 6100 | ready | program | Website reorganization — audit.md §3/§4 | Restructure flat 73-file frontend into core/shell/pages/editor, decompose mission_editor/editor_ops/arsenal monoliths, extract gestures via EditorGestureContext, nest backend handlers by domain. |
