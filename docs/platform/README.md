...
| [`t125_coding_standards_enforcement.md`](t125_coding_standards_enforcement.md) | **T-125 (in progress — active T-125.3)** — [`CODING_STANDARDS.md`](CODING_STANDARDS.md) + CI/lint; **T-125.1–.2.1 shipped** @ `80c7f07` (`ci.yml`, `make ci-local`, golangci full gate) |
