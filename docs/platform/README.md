...
| [`t124_dependency_upgrade.md`](t124_dependency_upgrade.md) | **T-124 (ready)** — dependency + toolchain upgrade: FE npm, Go modules, Go 1.26, Node 24, Postgres 18 (3 commits on main) |
| [`t125_coding_standards_enforcement.md`](t125_coding_standards_enforcement.md) | **T-125 (queued)** — `CODING_STANDARDS.md` + full CI/lint/strict enforcement (depends on T-124) |
