...
**Status:** **T-090.5.5 shipped** @ `2b1a0dda` · **Active:** **T-090.11** (architectural interiors — SurfaceKind BVH, portals, glazing, prop BLAS/TLAS; the T-090.6 3D-occlusion lane is shipped). Single lane.  
