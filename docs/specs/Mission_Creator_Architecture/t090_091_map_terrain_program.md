...
**Status:** **ready** — **Active slice:** **T-090.1.1**. **T-090.1.2.5 shipped** @ `6396960f` (water composite; refine `.2.5.1` for road FP / hill river FN). **T-090.1.2.6 shipped** @ `b958e3b4`. **T-090.1.2.8 shipped** @ `db9057ef` (tbd-sat v1). **T-091 complete** @ `dde589e`.  
...
T-090.0.2  map-object schemas + goldens + verify wiring (shipped @ this pass)  ✓
  ...
  → T-090.1.2.5  Satellite water composite  ✓ @ 6396960f (refine .2.5.1: roads FP, hill rivers FN)
...
**Blocker chain (110% satellite — post T-090.1.2.5):** optional **T-090.1.2.5.1** inland mask refine (roads/rivers) → **T-090.1.1** (Map) → **T-090.2** → …
...
| **T-090.1.2.5** | [`t090_1_2_5_satellite_water_composite.md`](t090_1_2_5_satellite_water_composite.md) | claude-code | **Water composite** — **shipped** @ `6396960f` (known gaps → `.2.5.1`) |
