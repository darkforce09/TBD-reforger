...
**Status:** **ready** — **Active slice:** **T-090.1.2.5.1** (inland mask refine). **T-090.1.2.5** @ `6396960f` · **T-090.1.2.6** @ `b958e3b4` · **T-090.1.2.8** @ `db9057ef`. **T-091** @ `dde589e`.  
...
| **T-090.1.2.5.1** | [`t090_1_2_5_1_water_mask_refine.md`](t090_1_2_5_1_water_mask_refine.md) | claude-code | **Inland mask refine** — **active** |
