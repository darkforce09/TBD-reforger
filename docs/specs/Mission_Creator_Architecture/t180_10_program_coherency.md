...
**Gate:** `make verify-t180` → [`scripts/verify-t180-coherency.sh`](../../../scripts/verify-t180-coherency.sh)
...
| J-L5 | `make verify-t180` must exit 0 on green main |
...
2. `scripts/verify-t180-coherency.sh` + `make verify-t180`
