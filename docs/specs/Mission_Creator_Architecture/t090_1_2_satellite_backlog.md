...
**Registry active slice:** `./scripts/ticket brief T-090` → **T-090.1.1**  
**Last shipped:** **T-090.1.2.5** @ `6396960f` (water composite) · **T-090.1.2.6** @ `b958e3b4` (hillshade slider)
...
| **Water** | **T-090.1.2.5** shipped @ `6396960f` — ocean + inland; **refine** T-090.1.2.5.1 (roads FP, hill rivers FN) |
...
2. T-090.1.2.5  Satellite water composite     ✓ @ 6396960f (refine → .2.5.1)
...
| **T-090.1.2.5** | shipped @ `6396960f` | [`t090_1_2_5_satellite_water_composite.md`](t090_1_2_5_satellite_water_composite.md) | verify log · known gaps → `.2.5.1` |
