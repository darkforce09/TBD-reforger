...
|--------|-------------|--------|
| **T-068** | Virtual Arsenal — through **T-068.9** ingest/worker; **T-068.10** Forge next | **Active T-068.10** — [`t068_virtual_arsenal_program.md`](t068_virtual_arsenal_program.md) |
