...
**Aegis reference:** full token spec in [docs/specs/Mission_Creator_Mock_Up/aegis_tokens/DESIGN.md](../../specs/Mission_Creator_Mock_Up/aegis_tokens/DESIGN.md). Runtime tokens live in `apps/website/frontend/src/index.css` (`@theme` block).
