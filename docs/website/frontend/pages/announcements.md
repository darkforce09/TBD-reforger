...
- **Route:** `/announcements`
- **Live source:** `apps/website/frontend/src/pages/operations.tsx` (`AnnouncementsPage`)
- **Stitch reference:** `apps/website/frontend/src/stitch-exports/command_announcements_feed/code.html` (archived)
- **Min role:** `public-nav`
