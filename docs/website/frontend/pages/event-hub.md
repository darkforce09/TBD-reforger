...
- **Route:** `/events/:id`
- **Live source:** `apps/website/frontend/src/pages/events.tsx` (`EventHubPage`, `EventHubView`)
...
- **Live source:** same `OrbatSelector` in `apps/website/frontend/src/pages/events.tsx`
