...
- **Route:** `/missions/:id`
- **Live source:** `apps/website/frontend/src/pages/missions.tsx` (`MissionOverviewPage`, `MissionDossierBody`)
- **Stitch reference:** `apps/website/frontend/src/stitch-exports/operation_enduring_freedom_mission_overview/code.html` (archived)
- **Min role:** `public-nav`
- **Blueprint ref:** —
