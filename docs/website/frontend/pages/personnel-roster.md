...
- **Live source:** `apps/website/frontend/src/pages/admin.tsx` (`PersonnelPage`); data via `usePersonnel`
- **Stitch reference:** `apps/website/frontend/src/stitch-exports/personnel_roster_admin_management/code.html` (archived)
- **Min role:** `admin`
