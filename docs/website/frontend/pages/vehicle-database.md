...
- **Route:** `/vehicles`
- **Live source:** `apps/website/frontend/src/pages/doctrine.tsx` (`VehicleDatabasePage`)
- **Stitch reference:** `apps/website/frontend/src/stitch-exports/sop_wiki_vehicle_database_iff/code.html` (archived — vehicles section split out)
- **Min role:** `public-nav`
