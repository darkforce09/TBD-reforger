...
|---------|---------|------|
| Split-pane master/detail | Event Schedule, Announcements, Wiki | [`event-schedule.md`](../../../apps/website/frontend/docs/pages/event-schedule.md) |
| Create-over-list Dialog | Event Manager "Schedule Operation" | [`event-manager.md`](../../../apps/website/frontend/docs/pages/event-manager.md), `admin.tsx` |
| Slide-over dossier (no route replace) | Mission Library card → Sheet | [`mission-library.md`](../../../apps/website/frontend/docs/pages/mission-library.md) |
