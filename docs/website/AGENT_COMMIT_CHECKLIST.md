...
| **Coding standards (T-125)** | [`docs/platform/CODING_STANDARDS.md`](../platform/CODING_STANDARDS.md) + [`t125_coding_standards_enforcement.md`](../platform/t125_coding_standards_enforcement.md) — before commit: `make ci-local` green (needs `make db-up` + `nvm use`; includes `make verify-coding-standards`); Go: `golangci-lint run ./...` |
