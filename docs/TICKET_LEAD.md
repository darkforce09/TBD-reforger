...
- **T-180** (1760) — ORBAT + Eden placement program [ready] — ORBAT + Eden placement. **T-180.1** @ aeb51209 · **T-180.2 SHIPPED** @ 83557768 (tag T-180.2) — mutators/GC/add_vehicle. ACTIVE **T-180.3** map side tint. Pins: t180_class_r_pins.md. Hub: t180_orbat_eden_program.md.
