...
- **T-159** (1570) — Leptos UI rewrite (React SPA → Rust) [ready] — Worktree TBD-T-159 @ t-159-leptos-ui tip ebcabe1d. 24 pages byte-identical; T-159.15.0–.15.2 MC camera shipped (pan Class R). ACTIVE T-159.16 MissionDoc host. Hub: t159_leptos_ui_program.md.
