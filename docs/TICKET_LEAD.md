...
- **T-339** (3155) — Two gate-harness gaps T-320 could not reach from its own files [running] — Both found and diagnosed by T-320, both left because the files were outside its ownership. Neither is red today; both are one small change.
...
- **T-551** (3391) — T-550 Class-R only — no HTTP IT for events roster over-capacity omit [running] — FOUND by W60 adversarial verifier (CLEAN MINOR) after T-550.
...
- **T-552** (3392) — 0015 migration comment still narrates deferred two-seat (pre-0017 lore) [running] — FOUND by W60 adversarial verifier (CLEAN MINOR outside T-525 owns) after T-525.
