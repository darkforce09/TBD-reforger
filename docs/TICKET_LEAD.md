...
- **T-159** (1570) — Leptos UI rewrite (React SPA → Rust) [ready] — Worktree TBD-T-159 tip f2cd6178. 24 pages + T-159.15.x camera + T-159.16 MissionDoc host shipped. ACTIVE T-159.17 yrsPersist/session. Hub: t159_leptos_ui_program.md.
