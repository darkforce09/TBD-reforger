...
- **T-152** (1520) — Map cartographic fidelity (glyphs, text, labels) [ready] — Map cartographic fidelity — T-152.0–.9 shipped; T-152.10 automated E2E gate PASS; operator O1–O12 pending before program done. Hub: t152_map_cartographic_fidelity_program.md.
