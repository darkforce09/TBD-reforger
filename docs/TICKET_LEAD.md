...
- **T-090** (900) — Map visualization program [ready] — Eden-like map detail (N1-N12). T-090.1.2.5.1 @ 82488c6f (inland water refine). Active: T-090.1.1 Map view. Parallel: T-090.2 taxonomy @ ticket/T-090-2. Residual hydrology gaps — operator post-ship @ verify log. Hub: t090_091_map_terrain_program.md.
