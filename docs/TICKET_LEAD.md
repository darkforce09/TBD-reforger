...
- **T-180** (1760) — ORBAT + Eden placement program [ready] — ORBAT + Eden placement. .1–.4 shipped · **T-180.5 SHIPPED** @ 1324799c (tag T-180.5) Eden chips. ACTIVE **T-180.6** place/refile↔ORBAT sync. Pins: t180_class_r_pins.md. Hub: t180_orbat_eden_program.md.
