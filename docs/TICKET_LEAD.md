...
- **T-180** (1760) — ORBAT + Eden placement program [ready] — ORBAT + Eden placement. .1–.5 shipped · **T-180.6 SHIPPED** @ 056c9a1a (tag T-180.6) place/refile sync. ACTIVE **T-180.7** Stitch ORBAT Manager UI. Pins: t180_class_r_pins.md. Hub: t180_orbat_eden_program.md.
