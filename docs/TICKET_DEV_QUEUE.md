...
- **Active slice:** `T-152.2`
- **Slice spec:** `docs/specs/Mission_Creator_Architecture/t152_2_reforger_icon_art.md`
- **Program hub:** `docs/specs/Mission_Creator_Architecture/t152_map_cartographic_fidelity_program.md`
- **Branch:** `ticket/T-152`
- **Targets:** root, website, shared
- **Summary:** Map cartographic fidelity. Active: T-152.2 Reforger icon art. T-152.0 docs + T-152.1 text lane shipped. Hub: t152_map_cartographic_fidelity_program.md.
